...
type UserRepository interface {
	...
	CheckSecretSetVerifiedAttr(ctx context.Context, secret string) (*User, error)
	ChangePasswordIfVerified(ctx context.Context, userID int, newPassword string) error
}
